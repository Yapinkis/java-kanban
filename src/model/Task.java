...
public class Task {
    ...
    public Task(String name, String description, long duration) {
        ...
        //Я решил по дефолту создавать задачи с 1 значением времени, что бы не плодить null который вызывает много
        //исключений, я же могу так сделать или это не рабочая практика?
        this.duration = Duration.ofMinutes(duration);
    }
